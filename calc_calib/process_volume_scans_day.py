...
outdir = '/gws/nopw/j04/ncas_radar_vol2/data/xband/raine/calibrations/Zcalib/phi_files/020620_att/'
if not os.path.exists(outdir):
    os.makedirs(outdir)

#Directory for logs
logdir = '/gws/nopw/j04/ncas_radar_vol2/data/xband/raine/calibrations/Zcalib/logs'
success_dir = os.path.join(logdir,'success_020620_att')
no_rays_dir = os.path.join(logdir,'no_rays_020620_att')
