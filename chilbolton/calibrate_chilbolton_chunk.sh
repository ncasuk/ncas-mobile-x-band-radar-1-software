...
params_file=/home/users/lbennett/lrose/ingest_params/chilbolton/june2020/RadxConvert.chilbolton.calib.0$params_index
...
for ncfile in $input_files; do
    ...
    failure_dir=$LOG_BASEDIR/chilbolton/failure/$YYYY/$MM/$DD
    success_dir=$LOG_BASEDIR/chilbolton/success/$YYYY/$MM/$DD
    ...
    output_dir=$CHIL_SCR_DIR/calib_v2/$scan_type/$DATE
	...
	gws_location=$CHIL_GWS_DIR/calib_v2/${scan_type}/$DATE/
