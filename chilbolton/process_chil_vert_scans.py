...
wxdir = '/gws/nopw/j04/ncas_obs/amf/raw_data/ncas-aws-2/data/chilbolton/NOAA/'

#Directory for radar data
raddir = '/gws/nopw/j04/ncas_radar_vol2/data/xband/chilbolton/cfradial/uncalib_v1/vert/'
dates = os.listdir(raddir)
dates.sort()

#Directory for processed data
outdir = '/gws/nopw/j04/ncas_radar_vol2/data/xband/chilbolton/calibrations/ZDRcalib_2020/'

#Directory for logs
logdir = '/gws/nopw/j04/ncas_radar_vol2/data/xband/chilbolton/calibrations/ZDRcalib_2020/logs'
